...
import {Alert, Text, TextInput, View, StyleSheet, TouchableWithoutFeedback, Animated } from 'react-native';
...
const mostrarAlerta=()=>{
Alert.alert('Error','Deber seleccionar un pais'),[{Text:'entendido'}]
}
